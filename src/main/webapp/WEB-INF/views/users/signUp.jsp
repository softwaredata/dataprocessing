        ...
        <%--<fieldset>--%>
            <div class="form-group" id="divId">
                ...
                <div class='kickass_field'>
                    <input maxlength='30' required='required' type="text"
                           class="form-control onlyAlphabetAndNumber" id="studentIdx"
                           data-rule-required="true" name="studentIdx">
            ...
            <div class="form-group">
                <div class='kickass_field'>
                    ...
                    <br /><br />
                    <a href="/login" class="btn badge-light">로그인 페이지 이동</a>
                </div>
            </div>
        <%--</fieldset>--%>
    </form>
