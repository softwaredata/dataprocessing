				...
				<div class="form-group" id="divId">
					<div class='kickass_field'>
						<input maxlength='30' required='required' type="text"
							...
							data-rule-required="true" placeholder="학번 입력">
					...
					<div class='kickass_field'>
						<input maxlength='30' required='required' type="text"
							class="form-control onlyAlphabetAndNumber" id="id"
							data-rule-required="true" placeholder="아이디 입력">
				...
				<div class="form-group" id="divName">
					...
					<div class='kickass_field'>
						<input required='required' type="text"
							...
							maxlength="15" placeholder="이름 입력"">
				...
				<div class="form-group" id="divEmail">
					...
					<div class='kickass_field'>
						<input required='required' type="email" class="form-control"
							id="email" data-rule-required="true" placeholder="이메일 입력"
							maxlength="40">
